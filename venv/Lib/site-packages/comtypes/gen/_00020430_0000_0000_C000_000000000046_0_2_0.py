...
IFontDisp = Font
__all__ = [ 'OLE_HANDLE', 'FONTNAME', 'FONTSTRIKETHROUGH',
           'IFontEventsDisp', 'OLE_YSIZE_CONTAINER', 'Monochrome',
           'OLE_XSIZE_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_XSIZE_PIXELS', 'IPictureDisp', 'FONTSIZE',
           'StdPicture', 'OLE_TRISTATE', 'Gray', 'FontEvents',
           'Unchecked', 'Picture', 'StdFont', 'OLE_YPOS_HIMETRIC',
           'OLE_YPOS_PIXELS', 'OLE_XPOS_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_CONTAINER', 'Font',
           'Default', 'FONTBOLD', 'Checked', 'IPicture',
           'FONTUNDERSCORE', 'OLE_YSIZE_HIMETRIC', 'Color',
           'FONTITALIC', 'VgaColor', 'OLE_OPTEXCLUSIVE', 'IFont',
           'LoadPictureConstants', 'IFontDisp', 'OLE_COLOR',
